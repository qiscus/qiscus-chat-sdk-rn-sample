...
export default class ChannelContactChooser extends React.Component {
	state = {
		contacts: {},
		selected: [],
		isBroadCast: true,
			...
			<View style={styles.container}>
				...
				<View style={styles.broadcastContainer}>
					<Switch
						...
						onValueChange={(isBroadCast) => this.toggleSwitch(isBroadCast)}
					/>
					<Text style={styles.inputSearch}>only admin can post</Text>
				</View>
	...
	toggleSwitch = (isBroadCast) => {
		this.setState({ isBroadCast });
		console.log(this.state.isBroadCast);
	};
	...
	_onSubmit = () => {
		this.props.onSubmit(this.selectedContacts, this.isGroupBroadcast);
	};
	...
	get isBroadCast() {
		return Object.values(this.state.isBroadCast);
	}
